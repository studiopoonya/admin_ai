...
const NAV_ITEMS = [
    ...
    { to: '/home', label: 'Dashboard', roles: ['admin'], icon: (
    ...
    { to: '/logistics', label: 'Logistik', roles: ['admin', 'staff_logistic', 'staff_operasional'], icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
        </svg>
    )},
    { to: '/logistic-staff', label: 'Ops Logistik', roles: ['admin', 'staff_logistic', 'staff_operasional'], icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
        </svg>
    )},
    { to: '/op-settings', label: 'Op. Settings', roles: ['admin', 'staff_logistic', 'staff_operasional'], icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
